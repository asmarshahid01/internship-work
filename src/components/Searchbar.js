...
export default function Searchbar({ searchTxt, setSearchTxt }) {
  return (
    <div id='search-bar-container'>
        <input id='search-bar' type='text' placeholder='Search' value={searchTxt}
        ...
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor'>
            ...
            6.1325 4 11C4 14.8675 7.1325 18 11 18ZM19.4853 18.0711L22.3137 20.8995L20.8995 22.3137L18.0711
